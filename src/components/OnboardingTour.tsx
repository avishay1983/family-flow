...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    target: 'backlog',
    title: 'מחסן משימות — המשימות האישיות שלך 📋',
    description: 'כאן תוכל לשמור משימות לתכנון עתידי. המחסן הוא אישי — כל משתמש רואה רק את המשימות שלו. כשתהיה מוכן, תוכל לקשר אותן למרחב עבודה.',
    placement: 'bottom',
